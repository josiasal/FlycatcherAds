...
namespace FlycatcherAds.Models
{
    public class LineItem
    {
        ...
        [JsonProperty("placements")] public string[] Placements { get; set; }
        ...
        [JsonProperty("bid_strategy")] public string BidStrategy { get; set; }
        ...
        [JsonProperty("pay_by")] public string PayBy { get; set; }
